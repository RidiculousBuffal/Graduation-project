...
def create_inspection():
    ...
    try:
        ...
        return ResponseModel.success(msg=InspectionConsts.InspectionRecordInsertSuccess,data=result.model_dump()).to_dict()
...
def get_inspection(inspection_id):
    ...
    try:
        ...
        return ResponseModel.success(msg=InspectionConsts.InspectionRecordFetchSuccess,data=inspection.model_dump()).to_dict()
    except Exception as e:
...
def update_inspection(inspection_id):
    ...
    try:
        ...
        if not result:
            return ResponseModel.fail(f"{InspectionConsts.InspectionRecordNotFound}: {inspection_id}").to_dict(), 404
        return ResponseModel.success(msg=f'{InspectionConsts.InspectionRecordUpdateSuccess}',data=result.model_dump()).to_dict()
    except Exception as e:
...
def search_inspections():
    ...
    try:
        ...
        return ResponseModel.success(msg=InspectionConsts.InspectionRecordFetchSuccess,data=result.model_dump()).to_dict()
    except Exception as e:
        return ResponseModel.fail(f"{InspectionConsts.InspectionRecordFetchFailed}: {str(e)}").to_dict(), 400
